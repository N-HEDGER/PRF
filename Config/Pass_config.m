...
scr.stimrecth=scr.stimrecth-[0 (scr.scr_sizeY/2)+(const.barsize(2)/2) 0 (scr.scr_sizeY/2)+(const.barsize(2)/2)];
...
% Make a linearly spaced vector that extends from the start postion to the same postion off
% the other side of the screen.
const.positionvech=linspace(0,scr.scr_sizeY+const.barsize(2),const.positionsh);
